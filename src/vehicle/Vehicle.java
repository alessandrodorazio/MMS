...
public abstract class Vehicle {
	...
	public static class BuildVehicle {
		...
		public Vehicle build() {
			...
			if (this.environmentalClass > 0 && this.environmentalClass <= Costant.EURO_MAX)
				v.environmentalClass = this.environmentalClass;
			v.year = this.year;
			v.axis = this.axis;
	...
	public int getEnvironmentalClass() {
		return environmentalClass;
	}

	protected void setEnvironmentalClass(int environmentalClass) {
		this.environmentalClass = environmentalClass;
	}
	...
	protected int getNoisePollution() {
		return noisePollution;
	}

	protected void setNoisePollution(int noisePollution) {
		this.noisePollution = noisePollution;
	}

	public char getUnitRate() {
		return unitRate;
	}
